...
readout the proxy under-reads seed noise at every scale (median truth-SD / proxy-SD; parity
and $\sqrt{2}$ references; 750M is budget-truncated) --- Section~\ref{app:t1-port}. (c) On
