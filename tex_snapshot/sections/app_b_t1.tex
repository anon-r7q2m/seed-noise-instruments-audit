...
Two honest qualifications. (i) The ceiling is a \emph{perfect-proxy reference} at $n = 3$, not on the proxy: better instruments could exist; under the conventional certificate at this seed budget, none can be \emph{validated} against a 3-seed truth beyond this resolution with useful power. (ii) On the macro
