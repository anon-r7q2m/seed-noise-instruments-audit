...
Section~\ref{sec:t1-port}'s ranking claim, in full. Per (scale, task) cell we rank the 25
...
\emph{overestimates} seed noise by $1.1$--$7\times$. The cause is mechanical: on coarse
