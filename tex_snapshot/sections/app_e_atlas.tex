...
typical $0.5$--$1$pp ablation gap at 14m--31m (shaded band) lies inside $1\sigma$; the one
divergent run (\textsc{blimp} 31m, $-3.9$pp) is labeled. (b) Checkpoint-proxy noise vs
