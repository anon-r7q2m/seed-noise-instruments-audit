...
homogeneity, with the spread factor per size on top; 1B is the negative control.}
\label{fig:atlas}
\end{figure}
\begin{figure}[!tbp]
\centering
...
direction and at the high end of the per-domain range in magnitude (the cross-domain median
is $1.5\times$). Leave-one-recipe-out, the C4-en factor spans
