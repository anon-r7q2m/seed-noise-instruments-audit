...
24 at 60M): at that grid the runs are still descending at seed-dependent rates, so the
per-seed endpoints carry seed-varying residual trend, which reads as cross-seed noise; the
