...
(Section~\ref{sec:t2}); we prove them here. In part (i), the explicit binary example has
...
seeds) against $\hat\sigma_{\mathrm{order}}$ (SD across recipes) on the S\&N 1B arms,
