...
0.75 = 0.47$ (signal rise) $+\ 0.29$ (noise drop, RMS basis; on the median-noise basis the
noise share is larger); the elevated 60M noise is carried by a few recipe outliers
...
\texttt{r9\_decidable\_accuracy.json}).
