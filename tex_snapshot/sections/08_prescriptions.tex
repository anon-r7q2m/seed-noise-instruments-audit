...
1B arms --- a single-asset observation; measured $2.4$--$4.0\times$ at our 20M controls),
...
Appendix~\ref{app:t3}.) The seed answer has a price: holding the measured noise fixed, the
decidable share leaves zero at $n{=}4$ seeds and passes $50\%$ at $n{=}8$ at 60M, while at 4M
even $n{=}30$ buys only $56\%$ --- at 4M the missing ingredient is signal, not seeds
(Appendix~\ref{app:t3}).
