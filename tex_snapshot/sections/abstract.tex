...
($r = -0.56$; robust to recipe resampling, borderline once seed noise is priced in),
so seed averaging can track the wrong ranking more faithfully. We release code, a
