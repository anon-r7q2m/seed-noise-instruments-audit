...
(${\sim}1.6\times$ at 1B, non-monotone across scales, up to $2.4\times$, reversed on
...
($r = -0.56$; robust to recipe resampling, borderline once seed noise is priced in), so seed
averaging can track the wrong ranking; no inversion appears on the perplexity readout. We release code, a
