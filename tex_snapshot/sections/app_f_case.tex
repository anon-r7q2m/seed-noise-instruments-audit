...
The upstream report is prepared and being filed by the authors personally: a dataset issue on the
release plus a letter to the maintainers, with the per-file exclusion list, sha256 hashes, and a
minimal reproduction script (to be cited, anonymized, once filed). Our reading
of the release is a
