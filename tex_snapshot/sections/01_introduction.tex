...
seeds tracks the wrong ranking more faithfully (the point-estimate gap, $-6.8$pp, is itself
not robust to recipe resampling; the inversion is). Of the
...
(Proposition~\ref{prop:t1-bound}, Monte-Carlo-calibrated at the panel's own operating point,
Appendix~\ref{app:t1-mc}) --- and single-source arms cannot
...
dependence-robust variants alike) --- measure the seeds instead.
