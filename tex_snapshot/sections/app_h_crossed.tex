...
interaction bound shrinks to $0.0$--$1.0$ points after quadrature subtraction;
...
160M additivity holds but the ratio drifts by task; at 20M the main effects are not
detectable and the joint cell dominates.}
\label{tab:crossed}
\footnotesize
