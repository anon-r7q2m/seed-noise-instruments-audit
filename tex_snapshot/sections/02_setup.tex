...
4M macro ranking inverts against 1B ($r = -0.56$) & accurate at the recommended scale; where
the decidable share is $0$ (on this panel: every scale $\le 60$M), abstain and measure seeds \\
\bottomrule
\end{tabular}
\end{table}
