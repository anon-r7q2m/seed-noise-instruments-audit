...
The public-asset evidence comes from three assets released with per-seed resolution:
...
$\sqrt{\max(S^2 - \overline{\hat\sigma^2}/3,\,0)}$, whose SNR uses the root-mean-square (RMS) noise
