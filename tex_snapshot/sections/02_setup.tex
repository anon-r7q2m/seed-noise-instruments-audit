...
${\sim}1.6\times$ on accuracy (more at small scale), over-reads $2$--$7\times$ on perplexity;
...
4M macro ranking inverts against 1B ($r = -0.56$) & accurate at the recommended scale; at SNR
$< 1$, abstain and measure seeds \\
\bottomrule
\end{tabular}
\end{table}
