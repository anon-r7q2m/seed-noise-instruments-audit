#!/usr/bin/env python3
"""Canonical generators for the r5_*/r8_* jsons (rewrites them in place):
...
Prints PASS/FAIL per item and writes r5_r8_regen_report.json.
"""
import os, json, sys
import numpy as np
import pandas as pd
...
# merge: preserve the argmax / blocks_1b / acc4 sections produced by r5_review2_verification.py
