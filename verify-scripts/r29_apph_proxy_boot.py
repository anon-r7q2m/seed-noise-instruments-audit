#!/usr/bin/env python3
"""r29_apph_proxy_boot: the 20M proxy-calibration
...
derived from the stage-2 runs' eval_step*.json + eval_final.json. Writes r29_apph_proxy_boot.json.
"""
import os, json
import numpy as np
import pandas as pd
...
CSV = os.environ.get("NFT_STAGE2_SERIES",
                     os.path.join(_ROOT, "data", "stage_results", "stage2_ckpt_series.csv"))
