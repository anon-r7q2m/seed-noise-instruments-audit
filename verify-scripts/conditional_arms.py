...
Asserts (numbers in the paper, App H 20M paragraph):
  ...
  - bundled SD (n=10: 4 grid diagonal + 6 extra) matches the archived earlier-grid table digit for digit (sampling kernel blimp 0.0081)

Data: grid_evals/i*_o*/eval_final.json (shipped under data/self_run_controls/; NFT_GRID_EVALS overrides).
"""
import json, os, sys
import numpy as np
