#!/usr/bin/env python3
"""Triage checks of factual claims against the data lake; each section prints
the claim numbers and a verdict. Pure CPU, deterministic.
"""
import os, json
import numpy as np
import pandas as pd
...
# compare the arc_challenge result files of two seeds, config side by side
import glob as _g2
