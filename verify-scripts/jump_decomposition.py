#!/usr/bin/env python3
"""Decomposition of the 60M->90M deconvolved-SNR jump into signal rise vs noise
drop, on the accuracy and bpb readouts; plus per-recipe noise outliers at 60M
and checkpoint-grid density per scale; writes jump_decomposition.json.
"""
import os, json
import numpy as np
import pandas as pd
...
with open(os.path.join(HERE, "jump_decomposition.json"), "w") as f:
    json.dump(OUT, f, indent=1)
print("wrote jump_decomposition.json")
