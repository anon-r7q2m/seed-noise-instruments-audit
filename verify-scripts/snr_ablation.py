#!/usr/bin/env python3
"""snr_ablation: decompose the SNR head-to-head gain.
...
interval on the A->C difference. Writes snr_ablation.json. Pure CPU, deterministic.
"""
import os, json
import numpy as np
import pandas as pd
...
json.dump(out, open(os.path.join(HERE, "snr_ablation.json"), "w"), indent=1)
print("wrote snr_ablation.json")
