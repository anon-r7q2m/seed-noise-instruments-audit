#!/usr/bin/env python3
"""hme_full_correction: two consistency checks on the HME.
...
Writes hme_full_correction.json. Pure CPU. NFT_DD / NFT_HME_SRC overridable.
"""
import json, os, sys
import numpy as np
import pandas as pd
...
HME_SRC = os.environ.get("NFT_HME_SRC", os.path.join(_ROOT, "code", "enhancement3"))
...
json.dump(results, open(os.path.join(HERE, "hme_full_correction.json"), "w"), indent=1)
print("wrote hme_full_correction.json")
