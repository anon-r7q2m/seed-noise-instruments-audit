#!/usr/bin/env python3
"""Replay of the 4M-vs-1B decision analysis on the 11-domain perplexity readout
(full 14 scales x 3 seeds): per-scale pairwise accuracy of 3-seed-mean macro
log-ppl against the 1B log-ppl target, and the 4M macro ranking's correlation
with the 1B ranking; writes bpb_replay.json.
"""
import os, json
import numpy as np
import pandas as pd
...
with open(os.path.join(HERE, "bpb_replay.json"), "w") as f:
    json.dump(OUT, f, indent=1)
print("wrote bpb_replay.json")
