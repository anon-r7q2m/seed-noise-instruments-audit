#!/usr/bin/env python3
"""cv_f_check: is the exact F interval valid for the relative-SD (CV) ratio?
...
Writes cv_f_check.json; prints ALL PASS if coverage stays within [0.940, 0.960].
"""
import json, os
import numpy as np
...
json.dump(out, open(os.path.join(HERE, "cv_f_check.json"), "w"), indent=1)
