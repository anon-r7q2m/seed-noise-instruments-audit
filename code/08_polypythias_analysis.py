...
Reads data/analysis/pp_tidy.parquet (5 sizes x 10 seeds; seed bundles init and data order);
writes data/tables/pp_{final_seed_noise,outliers,t1_ratio}.csv and data/figs/PP_seednoise.png.
"""
