...
Reads data/analysis/dd_tidy.parquet; writes data/analysis/t1b_cells.parquet and
data/tables/t1b_{R_per_size_recipe,summary_by_size,pooled_by_size}.csv.
Also reports a Monte-Carlo ceiling (R distribution if the proxy were perfect given
3-seed / n-ckpt chi^2 estimation error) and a permutation null.
"""
