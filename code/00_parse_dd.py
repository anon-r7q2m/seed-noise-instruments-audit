#!/usr/bin/env python3
"""Parse the DataDecide macro_avg parquet into tidy long format.

Input : tmp/data/dd_macro_avg.parquet  (metrics column as JSON string)
Output: data/analysis/dd_tidy.parquet  (params, data, task, step, seed, tokens, compute,
        primary_metric, acc_raw, acc_per_char, correct_prob_per_char, bpb)
"""
