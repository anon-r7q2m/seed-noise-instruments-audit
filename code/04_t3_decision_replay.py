...
Reads data/analysis/dd_tidy.parquet; writes data/tables/t3_decision_replay.csv,
data/tables/t3_by_size_tasklevel.csv, data/analysis/t3_pairs.parquet.
Decision for pair (i,j): sign(pred_i - pred_j) vs sign(target_i - target_j), with
target = 1B 3-seed mean and pred = small-size score (3-seed mean and single-seed).
A pair is seed-unstable if the 3 single-seed decisions do not all agree (small or 1B side).
"""
