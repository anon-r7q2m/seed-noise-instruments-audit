#!/usr/bin/env python3
"""App D decision replay: pairwise recipe decisions vs the 1B consensus,
300 pairs per scale.
...
Data: data/tables/t3_decision_replay.csv (macro rows; paper numbers asserted
in-script).
...
CSV = os.path.join(os.environ.get("NFT_TABLES", os.path.join(_ROOT, "data", "tables")), "t3_decision_replay.csv")
