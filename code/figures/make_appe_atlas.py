#!/usr/bin/env python3
"""App E atlas: noise is a function of the recipe.
...
Data: data/analysis/t1c_ppl_cells.parquet. Paper numbers asserted.
...
PQ = os.path.join(os.environ.get("NFT_R", os.path.join(_ROOT, "data", "analysis")), "t1c_ppl_cells.parquet")
